...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sn117020:g3tULq1KLqxgzfgd@cluster0.ju3tzdx.mongodb.net/?retryWrites=true&w=majority&appName=RaidenShogunFileBot")
DB_NAME = os.environ.get("DATABASE_NAME", "Raiden_Shogun_File_Bot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://graph.org/file/b866b2bb0d60b6dd0daa3-81aaec558d33bedc2c.jpg")).split() #Required
